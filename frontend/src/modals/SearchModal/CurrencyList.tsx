  ...
  return (
    <div
      ...
      className={classNames(
        ...
        `flex items-center w-full space-x-3 rounded-md hover:bg-indigo-800 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500 px-4 py-2 token-${currency?.symbol}`
      )}
      style={style}
